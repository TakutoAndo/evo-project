...
void PrintCrossover(int flag, int parent1, int parent2, int child1, int child2, int n_cross)
{
    ...
    case BEFORE:
        printf("parent1 |");
        PrintEachKeyboardFitness(parent1);
        printf("parent2 |");
        PrintEachKeyboardFitness(parent2);
        printf("delete1 |");
        PrintEachKeyboardFitness(child1);
        printf("delete2 |");
        PrintEachKeyboardFitness(child2);
        printf("n_cross=%d\n", n_cross);
        break;
    case AFTER:
        printf("child1 |");
...
void PrintMutation(int flag, int child, int n_mutate1, int n_mutate2)
{
    ...
    case BEFORE:
        printf("child(OLD)|");
        PrintEachKeyboardFitness(child);
